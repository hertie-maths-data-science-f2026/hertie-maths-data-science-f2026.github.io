...
links: []
---
Materials for session 8 are not released yet - they will appear in [`materials/lectures/08_lecture`](https://github.com/hertie-maths-data-science-f2026/materials) when released.
