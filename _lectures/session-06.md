...
links: []
---
Materials for session 6 are not released yet - they will appear in [`materials/lectures/06_lecture`](https://github.com/hertie-maths-data-science-f2026/materials) when released.
