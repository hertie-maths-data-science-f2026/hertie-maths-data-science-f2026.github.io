...
links: []
---
Materials for session 12 are not released yet - they will appear in [`materials/lectures/12_lecture`](https://github.com/hertie-maths-data-science-f2026/materials) when released.
